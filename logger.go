...
// NewLogger sets up logging and should be called before log functions, usually in
...
// LogLevel describes the LogLevel of verbosity for info messages when using
...
// V generates a log record depends on the setting of the LogLevel; or none default.
